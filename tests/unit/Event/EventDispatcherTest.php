...
class EventDispatcherTest extends TestCase
{
    ...
    {
        $this->dispatcher->doDispatch(EventDispatcherFake::EVENT_VALID, new StoppableEvent());
    ...
    {
        $this->dispatcher->doDispatch(EventDispatcherFake::EVENT_INVALID, new StoppableEvent());
    }
}
